    ...
    <header>
        <nav>
            <div id="flex-container" class="topnav">
                ...
                <div class="flex-items"><a href="news/news.html">Actualités</a></div>
                <div class="flex-items"><a href="contact/contact.html">Contact</a></div>
                <div class="flex-items"><a href="topics/topics.html">Nos Guides</a></div>
                <div class="flex-items"><a href="equipe/equipe.html">Qui sommes nous ?</a></div>
