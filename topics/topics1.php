...
$sql = "SELECT * FROM topic_msg1 ORDER BY timestamp DESC LIMIT 100";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($message_text)) {
        ...
        $sql = "INSERT INTO topic_msg1 (user_name, msg) VALUES ('$nom_utilisateur', '$message_text')";
        // INSERT INTO `topic_msg1` (`id_u`, `msg`, `timestamp`) VALUES ('2', 'hjtfhj', CURRENT_TIMESTAMP);
        $conn->query($sql);
...
<body>
    ...
    <section>
        <H1 id="title_topic">Quel est la meilleure classe pour débuter</H1>
